    ...
    return (
      <Page>
        ...
        <ContentBlock inner>
          ...
          <Button round style={pStyle}>
            Button Round
          </Button>
          <Button fill style={pStyle}>
            Button Fill
          </Button>
          ...
          <GridRow style={pStyle}>
            <GridCol>
              <Button big fill color="green">
                Send
              </Button>
            </GridCol>
            <GridCol>
              <Button big fill color="red">
                Delete
              </Button>
            </GridCol>
          </GridRow>
          <GridRow style={pStyle}>
            <GridCol>
              <Button fill raised color="green">
                Raised
              </Button>
            </GridCol>
            <GridCol>
